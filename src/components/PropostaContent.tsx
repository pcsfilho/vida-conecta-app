import { CheckCircle, Users, Building2, FileText, Calendar, AlertCircle, Zap } from 'lucide-react';
...
const PropostaContent = ({ showCTA = true, onCTAClick }: PropostaContentProps) => {
