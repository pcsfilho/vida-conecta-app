...
const Dashboard = () => {
  ...
  const menuItems = [
    ...
    { id: "funcionarios", label: "Funcionários M1", icon: Users },
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-yellow-800 mb-4">
                        Precisamos dos dados dos seus funcionários para iniciar
                        a elaboração do PGR
                      </p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-blue-800 mb-4">
                        Preencha os dados da Planilha M1 de forma facilitada
                        através do nosso formulário digital inteligente
                      </p>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-green-50">
                    Solução completa em saúde e segurança ocupacional
                  </p>
                </div>
              </div>
              <button
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-50">
                    Revise e assine digitalmente o contrato de prestação de
                    serviços
                  </p>
                </div>
              </div>
            ...
            <div className="border-t border-gray-200 p-6 bg-gray-50">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  onClick={() => {
                    alert(
                      "Funcionalidade de assinatura digital em desenvolvimento"
                    );
                  }}
                >
