...
import { CheckCircle, Users, Building2, FileText, Calendar, HeadphonesIcon, AlertCircle, Zap } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Analisando perfil da sua empresa...</h2>
          <p className="text-gray-600">Identificando NRs aplicáveis e montando proposta personalizada</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-gray-50 rounded-lg p-4 mt-6">
            <div className="flex justify-between items-center text-sm">
              <div>
                ...
                <p className="font-bold text-gray-900">R$ {investimentoMin.toLocaleString('pt-BR')}</p>
              </div>
            ...
            <p className="text-xs text-gray-500 mt-2 text-center">
              *Valores estimados baseados no porte da empresa. Investimento final poderá variar conforme necessidades identificadas.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-purple-50 rounded-xl p-6 text-center">
            ...
            <div className="text-3xl font-bold text-purple-600 mb-1">{numEmployees}</div>
            <div className="text-sm text-gray-600">Funcionários</div>
          </div>

          <div className="bg-green-50 rounded-xl p-6 text-center">
            <Building2 className="w-8 h-8 text-green-600 mx-auto mb-2" />
            <div className="text-3xl font-bold text-green-600 mb-1">{numUnits}</div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <div className="flex items-center mb-6">
            ...
            <h3 className="text-2xl font-bold text-gray-900">NRs Aplicáveis à sua Empresa</h3>
          </div>

          <div className="space-y-4">
            {nrsAplicaveis.map((nr, index) => (
              nr.aplicavel && (
                <div key={index} className="border-l-4 border-primary-500 bg-gray-50 p-5 rounded-r-lg">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center mb-2">
                        ...
                        <h4 className="text-lg font-bold text-gray-900">{nr.titulo}</h4>
                      </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <div className="flex items-center mb-6">
            ...
            <h3 className="text-2xl font-bold text-gray-900">Pacote de Serviços Recomendados</h3>
          </div>
          ...
          <div className="space-y-3">
            {servicosRecomendados.map((service, index) => (
              <div key={index} className="flex items-start space-x-3">
                ...
                <span className={`${service.checked ? 'text-gray-700' : 'text-gray-500'}`}>
                  {service.title}
                </span>
              </div>
            ))}
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              <strong>Legenda:</strong> ✅ = Incluído no pacote • ⚡ = Não identificado como necessário para seu perfil
            </p>
          </div>
        </div>
        ...
        {/* Contact Info */}
        <div className="text-center">
          <p className="text-gray-600 mb-2">Dúvidas? Entre em contato com nosso time comercial:</p>
          <a
